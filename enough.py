...
while 1:
    system("cls||clear")
    print("""{}
  ______     __ __      ___    _ _____ _______ _______ ____  _   _ 
 |  _ \ \   / / \ \    / / |  | |_   _|__   __|__   __/ __ \| \ | |
 | |_) \ \_/ /   \ \  / /| |  | | | |    | |     | | | |  | |  \| |
 |  _ < \   /     \ \/ / | |  | | | |    | |     | | | |  | | . ` |
 | |_) | | |       \  /  | |__| |_| |_   | |     | | | |__| | |\  |
 |____/  |_|        \/    \____/|_____|  |_|     |_|  \____/|_| \_|
 
    Ara: {}              {}by {}https://github.com/byvuitton  
    ...
    if menu == 1:
        ...
        system("cls||clear")
        print(Fore.LIGHTWHITE_EX + " BY VUITTON WAS HERE")
        sleep(12)
    elif menu == 4:
        system("cls||clear")
